...
export default function Accordion({ question, children, expanded }: Props) {
  ...
  return (
    <motion.div
      ...
      className="w-full rounded-lg border border-blue-200 px-4 py-2 text-sm text-neutral-400 shadow-[0_0_1px_#fff,inset_0_0_1px_#fff,0_0_2px_#4bf,0_0_8px_#4bf,0_0_8px_#4bf]"
    >
      <button
